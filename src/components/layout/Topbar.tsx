        ...
        <div className="flex-1">
          <label className="relative block">
            ...
            <input
              ...
              className="w-full md:max-w-xl pl-9 pr-3 py-2 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-green-200 text-slate-900 placeholder:text-slate-400"
            />
          </label>
        </div>
