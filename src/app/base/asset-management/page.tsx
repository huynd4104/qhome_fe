        ...
        setTimeout(() => {
          setEditingAsset((prev) => {
            ...
            return {
              ...
              unitId,
              assetType: finalAssetType,
              roomType: ASSET_TYPE_TO_ROOM[finalAssetType] || RoomType.LIVING_ROOM,
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          value={editingAsset.roomType || RoomType.LIVING_ROOM}
                          onChange={(e) => {
                            setEditingAsset({ ...editingAsset, roomType: e.target.value as RoomType });
                            setTouchedFields({ ...touchedFields, roomType: true });
                          }}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
