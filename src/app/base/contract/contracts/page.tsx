...
// Labels tiếng Việt cho AssetType (14 loại)
...
const ASSET_TYPE_DEFAULT_PRICE: Record<AssetType, number> = {
  ...
  [AssetType.SINK]: 1500000,
  [AssetType.WATER_HEATER]: 3000000,
  [AssetType.SHOWER_SYSTEM]: 2000000,
  [AssetType.FAUCET]: 500000,
  [AssetType.LIGHT]: 400000,
  [AssetType.DOOR]: 2500000,
  [AssetType.WINDOW]: 1500000,
  [AssetType.ELECTRICAL_SYSTEM]: 1200000,
...
// All asset types (no longer grouped by room)
const ALL_ASSET_TYPES: AssetType[] = Object.values(AssetType);

// Room display order
const ROOM_ORDER: RoomType[] = [
  RoomType.BATHROOM, RoomType.LIVING_ROOM, RoomType.BEDROOM, RoomType.KITCHEN, RoomType.HALLWAY, RoomType.OTHER,
];
                          ...
                          <div className="px-3 py-2">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="text-xs text-gray-500">
                                ({ALL_ASSET_TYPES.length - missingAssetTypes.length}/{ALL_ASSET_TYPES.length})
                              </span>
                            </div>

                            <div className="ml-6 grid grid-cols-2 gap-x-4 gap-y-0.5">
                              {ALL_ASSET_TYPES.map((assetType: AssetType) => {
                                const exists = unitAssets.some(a => a.active && a.assetType === assetType);
                    ...
                    <div className="mt-2">
                      ...
                      <div className="space-y-2 max-h-60 overflow-y-auto">
                        <ul className="space-y-0.5 ml-2">
                          {ALL_ASSET_TYPES.filter((type: AssetType) => selectedAssetTypes.has(type)).map((type: AssetType) => (
