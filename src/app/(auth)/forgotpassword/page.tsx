              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg
                      className={`h-5 w-5 transition-colors duration-200 ${emailError
                        ? "text-red-400"
                        : isEmailFocused
                          ? "text-green-500"
                          : "text-slate-400"
                  ...
                  <input
                    ...
                    className={`w-full border-0 bg-[#E8E5DC] rounded-lg px-4 pl-10 py-3 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 transition-all duration-200 ${emailError
