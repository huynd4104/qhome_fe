            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border-0 bg-[#E8E5DC] rounded-md px-4 py-2.5 pr-10 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${passwordError
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border-0 bg-[#E8E5DC] rounded-md px-4 py-2.5 pr-10 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${confirmPasswordError
                    ? "focus:ring-red-500/30 ring-2 ring-red-500/30"
                    : "focus:ring-green-500/30"
                    }`}
                />
